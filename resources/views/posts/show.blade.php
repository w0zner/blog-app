  ...
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <flux:avatar class="mr-4 w-14 h-14" :name="$post->user->name" />
                      <div>
                          ...
                          <p class="text-base text-gray-500 dark:text-gray-400">
                            <time pubdate datetime="{{ $post->published_at !== null ? $post->published_at : $post->created_at }}" title="{{ $post->published_at !== null ? $post->published_at->format('M. d, Y') : $post->created_at->format('M. d, Y') }}">
                                {{ $post->published_at !== null ? $post->published_at->format('M. d, Y') : $post->created_at->format('M. d, Y')  }}
                            </time>
                        </p>
                      </div>
                  </div>
          ...
          <figure class="mb-4">
            ...
            <img src="{{ $post->image }}" class="w-full h-auto rounded-lg" alt="">
            <flux:text variant="subtle">Digital art by Anonymous</flux:text>
          </figure>
          ...
          <div class="mb-4">
            @foreach ($post->tags as $tag)
                <flux:badge color="lime">{{ $tag->name }}</flux:badge>
            @endforeach
          </div>
        ...
        @foreach($relatedPosts as $relatedPost) 
            <article class="max-w-xs">
                <a href="{{ route('posts.show', $relatedPost) }}">
                    {{-- <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-1.png" alt="Image 1"> --}}
                    <img src="{{ $relatedPost->image }}" alt="{{ $relatedPost->excerpt }}"  class="mb-5 rounded-lg">
                </a>
